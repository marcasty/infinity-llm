...
model_mapping: Dict[str, ModelSpec] = {
    # embedding models
    "text-embedding-3-small": ModelSpec(Provider.OPENAI, 8192, EmbedUsage(0.02*1e-3), RateLimit(5000, 5000000)), # dim 1536
    "text-embedding-3-large": ModelSpec(Provider.OPENAI, 8192, EmbedUsage(0.13*1e-3), RateLimit(5000, 5000000)), # dim 3072
    "text-embedding-ada-002": ModelSpec(Provider.OPENAI, 8192, EmbedUsage(0.1*1e-6), RateLimit(5000, 5000000)), # dim 3072
    # core gpt 4 models
    "gpt-4o": ModelSpec(Provider.OPENAI, 128000, ChatUsage(5.*1e-6, 15.*1e-6), RateLimit(5000, 600000)),
    "gpt-4o-2024-05-13": ModelSpec(Provider.OPENAI, 128000, ChatUsage(5.*1e-6, 15.*1e-6), RateLimit(5000, 600000)),
    "gpt-4-turbo": ModelSpec(Provider.OPENAI, 128000, ChatUsage(10.*1e-6, 30.0*1e-6), RateLimit(5000, 80000)),
    "gpt-4-turbo-2024-04-09": ModelSpec(Provider.OPENAI, 128000, ChatUsage(10.*1e-6, 30.0*1e-6), RateLimit(5000, 80000)),
    "gpt-4-turbo-preview": ModelSpec(Provider.OPENAI, 128000, ChatUsage(10.*1e-6, 30.0*1e-6), RateLimit(5000, 80000)),
    "gpt-4-0125-preview": ModelSpec(Provider.OPENAI, 128000, ChatUsage(10.*1e-6, 30.0*1e-6), RateLimit(5000, 80000)),
    "gpt-4-1106-preview": ModelSpec(Provider.OPENAI, 128000, ChatUsage(10.*1e-6, 30.0*1e-6), RateLimit(5000, 80000)),
    "gpt-4": ModelSpec(Provider.OPENAI, 8192, ChatUsage(30.*1e-6, 60.*1e-6), RateLimit(5000, 80000)),
    "gpt-4-0613": ModelSpec(Provider.OPENAI, 8192, ChatUsage(30.*1e-6, 60.*1e-6), RateLimit(5000, 80000)),
    "gpt-3.5-turbo-0125": ModelSpec(Provider.OPENAI,  16385, ChatUsage(0.5*1e-6, 1.5*1e-6), RateLimit(3500, 160000)),
    "gpt-3.5-turbo": ModelSpec(Provider.OPENAI,  16385, ChatUsage(0.5*1e-6, 1.5*1e-6), RateLimit(3500, 160000)),
    "gpt-3.5-turbo-instruct": ModelSpec("openai",  4096, ChatUsage(1.5*1e-6, 2*1e-6), RateLimit(3500, 160000)),
    "gpt-3.5-turbo-1106": ModelSpec(Provider.OPENAI,  16385, ChatUsage(1.*1e-6, 2.*1e-6), RateLimit(3500, 160000)),
    # anyscale
    "mistralai/Mistral-7B-Instruct-v0.1": ModelSpec(Provider.ANYSCALE, 32768, ChatUsage(0.15*1e-6, 0.15*1e-6), MaxInFlight(30)),
    "mistralai/Mixtral-8x7B-Instruct-v0.1": ModelSpec(Provider.ANYSCALE, 32768, ChatUsage(0.90*1e-6, 0.90*1e-6), MaxInFlight(30)),
    "mistralai/Mixtral-8x22B-Instruct-v0.1": ModelSpec(Provider.ANYSCALE, 64000, ChatUsage(0.50*1e-6, 0.50*1e-6), MaxInFlight(30)),
    "meta-llama/Meta-Llama-3-8B-Instruct": ModelSpec(Provider.ANYSCALE, 8192, ChatUsage(0.15*1e-6, 0.15*1e-6), MaxInFlight(30)),
    ...
    "mlabonne/NeuralHermes-2.5-Mistral-7B": ModelSpec(Provider.ANYSCALE, 32768, ChatUsage(0.15*1e-6, 0.15*1e-6), MaxInFlight(30)),
    ...
    # mistral
    "open-mistral-7b": ModelSpec(Provider.MISTRAL, 32768, ChatUsage(0.25*1e-6, 0.25*1e-6), MistralRateLimit(500000, 1000000000)),
    "open-mixtral-8x7b": ModelSpec(Provider.MISTRAL, 32768, ChatUsage(0.7*1e-6, 0.7*1e-6), MistralRateLimit(500000, 1000000000)),
    "open-mixtral-8x22b": ModelSpec(Provider.MISTRAL, 64000, ChatUsage(2*1e-6, 6*1e-6), MistralRateLimit(500000, 1000000000)),
    "mistral-small-latest": ModelSpec(Provider.MISTRAL, 32768, ChatUsage(1*1e-6, 3*1e-6), MistralRateLimit(500000, 1000000000)),
    ...
    "claude-3-5-sonnet-20240620": ModelSpec(Provider.ANTHROPIC, 200000, ChatUsage(3*1e-6, 15*1e-6), AnthropicRateLimit(4000, 400000, 50000000)),
    "claude-3-haiku-20240307": ModelSpec(Provider.ANTHROPIC, 200000, ChatUsage(0.25*1e-6, 1.25*1e-6), AnthropicRateLimit(4000, 400000, 100000000)),
    # groq # NOTE: currently on free plan
    "llama3-8b-8192": ModelSpec(Provider.GROQ, 8192, ChatUsage(0.05*1e-6, 0.08*1e-6), GroqRateLimit(30, 14400, 30000)),
    "llama3-70b-8192": ModelSpec(Provider.GROQ, 8192, ChatUsage(0.59*1e-6, 0.79*1e-6), GroqRateLimit(30, 14400, 6000)),
    "mixtral-8x7b-32768": ModelSpec(Provider.GROQ, 32768, ChatUsage(0.24*1e-6, 0.24*1e-6), GroqRateLimit(30, 14400, 5000)),
    "gemma-7b-it": ModelSpec(Provider.GROQ, 8192, ChatUsage(0.07*1e-6, 0.07*1e-6), GroqRateLimit(30, 14400, 15000)),
    # cohere 
    # rate limit: 10000 requests per minute, no TPM rate limit (used max value for 32-bit int)
    "command-r-plus": ModelSpec(Provider.COHERE, 200000, ChatUsage(3.*1e-6, 15.*1e-6), RateLimit(10000, 2147483647)),
    "command-r": ModelSpec(Provider.COHERE, 128000, ChatUsage(0.5*1e-6, 1.5*1e-6), RateLimit(10000, 2147483647)),
