...
from utils import Functionality, task_id_generator_function, APIRequest, StatusTracker, num_tokens_consumed_from_request
...
def get_default_request_url(provider: Provider, functionality: Functionality) -> str:
...
async def process_api_requests_from_file(
    ...
    request_url = get_default_request_url(provider, functionality)
